...
Isource = imread('data/digit_2_sample_10.png');
Imodel = imread('output/Registration_digit_2_sample_10_to_subject_0__t_19.png');
Itarget= imread('data/digit_2_sample_30.png');
