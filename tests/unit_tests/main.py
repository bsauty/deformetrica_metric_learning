...
TEST_MODULES = [KernelFactory, Kernel, DistanceTests, ArrayReadersAndWritersTests, PolyLineTests, PointCloudTests, SurfaceMeshTests, ShootingTests]
#TEST_MODULES = [ParallelTransportTests]
#TEST_MODULES = [ShootingTests]
