...
def main():
    ...
    common_parser.add_argument('--output_4_low_level', '-o', type=str, help='output_4_low_level folder')
    ...
    common_parser.add_argument('--verbosity', '-v',
                               ...
                               help='set output_4_low_level verbosity')
    ...
    if args.command == 'gui':
        ...
        try:
            if args.output is None:
                ...
                logger.info('No output_4_low_level directory defined, using default: ' + output_dir)
                os.makedirs(output_dir)
            else:
                logger.info('Setting output_4_low_level directory to: ' + args.output)
