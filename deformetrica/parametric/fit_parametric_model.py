...
args = {'command':'estimate', 'verbosity':'INFO', 'output':'output_10',
        'model':path+'model_after_initialization_10.xml', 'dataset':path+'data_set.xml', 'parameters':path+'optimization_parameters_saem.xml'}
