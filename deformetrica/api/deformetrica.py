...
class Deformetrica:
    ...
    def __init__(self, output_dir=default.output_dir, verbosity='INFO'):
        """
        Constructor
        :param str output_dir: Path to the output_4_low_level directory
        :param str verbosity: Defines the output_4_low_level log verbosity level. By default the verbosity level is set to 'INFO'.
        ...
        # create output_4_low_level dir if it does not already exist
    ...
    def estimate_registration(self, template_specifications, dataset_specifications,
        ...
        :param bool write_output: Boolean that defines is output_4_low_level files will be written to disk.
        :return:
        """
