...
from deformetrica.core import default, GpuMode
...
from deformetrica.core.models.model_functions import initialize_control_points, initialize_momenta, initialize_modulation_matrix, \
    initialize_sources, \
